...
import com.example.cailu.control.GSYvideplay.adapter.ListVideoAdapter;
...
public class ListVideo2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_gsyvideo_listvideo2);

        videoList = (ListView) findViewById(R.id.video2_list);
        videoFullContainer = (FrameLayout) findViewById(R.id.video2_full_container);
        activityListVideo = (RelativeLayout) findViewById(R.id.activity_list_video2);
