package com.example.cailu.control.Function.Magnify;
...
public class MagnifyView extends View {
    ...
    public MagnifyView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
      //  InputStream is = getResources().openRawResource(R.drawable.mn);
        mSrcBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.tu2);
